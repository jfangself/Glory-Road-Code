	...
	public void onCreate(Bundle savedInstanceState) {
		...
		itemList.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
					int position, long id) {
				// 获取被单击的列表项
				Long itemId = itemList.getAdapter().getItemId(position);
				String url = HttpUtil.BASE_URL + "delItem.jsp?itemId=" + itemId;
				DialogUtil.showDialog(ManageItem.this, "确认删除?", url);
				return true;
			}
		});
	}
