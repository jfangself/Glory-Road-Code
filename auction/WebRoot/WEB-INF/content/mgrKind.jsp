...
<tr height="24" <s:if test="#st.odd">
	...
	<s:else>style="background-color:#eeeeee"</s:else>>
<td>操作</td>
<td><a onclick="javascript:if (confirm('确定删除吗？')) { return true;}else{return false;};" href="proDelKind.action?kindId=<s:property value="id"/>" ">删除</a></td>
</tr>
</s:iterator>
<%
String message=(String)request.getAttribute("DelKindAction");
