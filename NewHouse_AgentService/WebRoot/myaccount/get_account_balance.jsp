...
<script src="<%=basePath%>js/myaccount/get_account_balance.js"
	type="text/javascript"></script>
</head>

<body>
	<center>
			<h1>查询我的资金账户余额信息接口</h1>
			<br>
			<form id="get_account_balance"
				action="<%=basePath%>agentService/myAccountServlet" method="post">
				<input type="hidden" name="action" value="get_account_balance">
				<table border="1">
					<tr>
						<td>参数名：</td>
